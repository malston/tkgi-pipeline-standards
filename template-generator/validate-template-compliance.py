    ...
    def validate_script_standards(self) -> None:
        ...
        for sh_file in sh_files:
            ...
            try:
                ...
                # Check shebang
                if not re.search(self.structure["script_patterns"]["shebang"], content, re.MULTILINE):
    ...
    def validate_fly_script(self) -> None:
        ...
        try:
            ...
            for opt in FLY_OPTIONS:
                ...
                # Look for evidence of option parsing
                if not re.search(rf"{short_opt}\)|\"{short_opt.replace('-', '')}", content, re.MULTILINE):
